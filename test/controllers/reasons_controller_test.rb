...
class ReasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reason" do
    assert_difference('Reason.count') do
      post reasons_url, params: { reason: { description: @reason.description, title: @reason.title, topic_id: @reason.topic_id } }
    end
  ...
  test "should update reason" do
    patch reason_url(@reason), params: { reason: { description: @reason.description, title: @reason.title, topic_id: @reason.topic_id } }
