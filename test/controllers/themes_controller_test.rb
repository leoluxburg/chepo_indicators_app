...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { reason_id: @theme.reason_id, title: @theme.title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { reason_id: @theme.reason_id, title: @theme.title } }
