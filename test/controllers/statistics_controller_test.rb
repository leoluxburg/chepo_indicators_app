...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { title: @statistic.title, value: @statistic.value } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { title: @statistic.title, value: @statistic.value } }
