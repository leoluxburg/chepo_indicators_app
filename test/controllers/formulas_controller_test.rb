...
class FormulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formula" do
    assert_difference('Formula.count') do
      post formulas_url, params: { formula: { indicator_id: @formula.indicator_id, statistic_id: @formula.statistic_id } }
    end
  ...
  test "should update formula" do
    patch formula_url(@formula), params: { formula: { indicator_id: @formula.indicator_id, statistic_id: @formula.statistic_id } }
